...
export function SetagayaAreaGuide({ hideCta = false }: { hideCta?: boolean }) {
  useEffect(() => {
    ...
    <div className="area-guide-container">
      ...
      <header className="guide-header animate-on-scroll">
        ...
        <div className="guide-date">
          <Calendar size={16} />
          2025年2月更新 | <Clock size={16} /> 読了時間: 5分
        </div>
      </header>
      ...
      <div className="section-card animate-on-scroll" style={{ marginBottom: "2rem" }}>
        ...
        <div className="content-item">
          ...
          <span className="keyword">
            <ThumbsUp size={16} /> 世田谷区をおすすめする方
          </span>
          :
        </div>
        <div className="area-features">
          <div className="feature-tag">
            <Train size={14} /> 都心アクセス良好
          </div>
          <div className="feature-tag">
            <Tree size={14} /> 緑豊かな環境
          </div>
          <div className="feature-tag">
            <Music size={14} /> 個性的な街の文化
          </div>
          <div className="feature-tag">
            <Users size={14} /> 家族向け環境
          </div>
          <div className="feature-tag">
            <Globe size={14} /> 国際的な環境
          </div>
        </div>
      </div>
        ...
        <div className="area-images-grid">
          <div>
            <Image
              ...
              priority
            />
            <p className="area-image-caption">下北沢の商店街 - 個性的な店が並ぶ文化の発信地</p>
          </div>
          <div>
            <Image
              ...
              priority
            />
            <p className="area-image-caption">二子玉川の多摩川沿い - 都会と自然が調和する住環境</p>
          </div>
        </div>
      </div>
      ...
      <div className="section-grid">
        ...
        <div className="section-card animate-on-scroll">
          ...
          <p className="content-item">
            <Info size={18} />
            *印は世田谷区に隣接する主要駅です。区境や生活圏を考慮した実用的な情報として参考にしてください。
          </p>
        </div>
        ...
        <div className="section-card animate-on-scroll">
          ...
          <p className="content-item">
            <Info size={18} />
            データ基準: 世田谷区全体の平均、2025年2月現在、管理費込み
          </p>
          <table className="area-table">
            <thead>
              <tr>
        ...
        <div className="section-card animate-on-scroll">
          ...
          <Image
            ...
            priority
          />
          <p className="area-image-caption">等々力渓谷 - 東京23区内唯一の渓谷</p>
        </div>
        ...
        <div className="section-card animate-on-scroll">
          ...
          <p className="area-image-caption">
            セント・メアリーズ・インターナショナルスクール - 世田谷区にある国際教育施設
          </p>
        </div>
      </div>
      ...
      {!hideCta && (
        <div className="search-section animate-on-scroll">
          <h2 className="search-title">あなたのお気に入りはどこ？</h2>
          ...
          <h3 style={{ marginTop: "1.5rem", marginBottom: "1rem" }}>路線で検索したい方はこちら</h3>
          <div className="search-options">
